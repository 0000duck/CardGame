...
namespace Client
{
    class Message
    {
        ...
        public Message getRegles()
        {
            return new Message()
            {
                Content = "\nVoici les règles du Choice Poker : " +
                ...
                "\n4. Vous ne pouvez pas vous coucher ni suivre la mise." +
                "\n     4.1 Vous pouvez seulement relancer ou laisser votre adversaire choisir l'ordre de force." +
